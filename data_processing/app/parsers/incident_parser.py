"""Parser for Declared Incident Reports telemetry."""
...
class IncidentReportParser(BaseParser):
    """Parser for Declared Incident Reports."""

    DATASET_TYPE = DatasetType.INCIDENT_REPORTS
    PRIMARY_KEY_CANDIDATES = ["incident_id", "id", "incidentId", "report_id"]
    TIMESTAMP_CANDIDATES = ["declared_at", "timestamp", "incident_date", "created_at"]
    ...
    def parse_stream(
        ...
        """Parses incident report stream detecting CSV or JSON."""
