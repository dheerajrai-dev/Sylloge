"""Parser for Alert Metadata telemetry."""
...
class AlertMetadataParser(BaseParser):
    """Parser specifically configured for Alert Metadata records."""

    DATASET_TYPE = DatasetType.ALERT_METADATA
    PRIMARY_KEY_CANDIDATES = ["alert_id", "id", "Incident_ID", "alertId", "event_id", "alert_uid"]
    TIMESTAMP_CANDIDATES = ["timestamp", "event_time", "EventTime_UTC", "time", "created_at", "@timestamp"]
    ...
    def parse_stream(
        ...
        """Parses alert stream detecting CSV or JSON automatically."""
